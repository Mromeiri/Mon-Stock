...
def indexx(request):
    ...
    # yearly_totals_2023 = get_total_amount_by_year(2023)
    ...
    context = {'total_sales': full,
               'products':products,
               'notification':notification,
               'top_4_suppliers':result,
    #           'total_assisted_rows':total_assisted_rows ,
    #           'total_students':total_students,
    #           'total_amount_students':total_amount_students,
    #           'final_amounts_all_students' :calculate_final_amount_for_all,
...
#         total_amount = PaymentParSeance.objects.filter(date_paid__gte=start_date, date_paid__lte=end_date).aggregate(total=Sum('amount'))
